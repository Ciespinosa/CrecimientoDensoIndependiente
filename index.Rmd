...
La dinámica de la población es una de las características más importantes de una población, los cambios en el tamaño poblacional resumen muchos de los procesos que se dan al interior de la comunidad, como las tasas de natalidad y mortalidad, así como, las emigraciones e inmigraciones. Comprender como la población cambia en el tiempo es fundamental para poder desarrollar acciones de manejo de especies protegidas o en peligro de extinción.

Uno de los modelos básicos de crecimiento poblacional es el __crecimiento denso-independiente__, este crecimiento  postula que la tasa de incremento _per capita_ no tiene dependencia estadística del tamaño de la población. En otras palabras, las tasas de natalidad y mortalidad de un individuo son independientes de número de individuos que tenga la población. Aunque biológicamente esto parezca que no tiene mucho sentido. Pero realmente el modelo de crecimiento denso-independiente propone la influencia que el tamaño de la población ejerza sobre la tasa de incremento debe ser  estadísticamente detectable. El detectar una relación significativa, al igual que en cualquier relación estadística,  depende entre otros de dos variables; el número de observaciones y el rango de la variable predictora. Por lo tanto, nuestra conclusión, de que una población en particular exhibe un crecimiento independiente de la densidad, puede ser difícil si el tamaño de muestra es pequeño (es decir, pocas generaciones muestreadas), o si muestreamos la población en un rango muy estrecho de densidades. 
...
Como vemos podemos calcular el incremento de la población en cualquier momento, únicamente es necesario que lo multipliquemos por tantos ciclos queremos proyectar, así, de enero a octubre hay tres ciclos por lo que deberíamos multiplicar la tasa de crecimiento tres veces: 2 x 2 x 2 o lo que es lo mismo $2^3$, así la tasa se eleva a la cantidad de ciclos que queremos proyectar la población. Ahora podemos generalizar e incluir en nuestra formula como:
